                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Text("User",style: TextStyle(fontSize: 25, color: Colors.white,
                              ),
                    ),

                            ],
                          ),
                          Text("9920934914",style: TextStyle(fontSize: 15, color: Colors.white,),),
                          Container(
                            padding: EdgeInsets.fromLTRB(0, 15, 0,5),
                            child: Row(
                              children: [
                                Icon(
                                  Icons.location_on, color: Colors.red[900],size: 25,
                                ),
                                Text("Navi Mumbai",style:TextStyle(fontSize: 17, color: Colors.black,), ),
                                Container(
                                  padding: EdgeInsets.fromLTRB(20, 0, 0, 0),
                                  child: Icon(Icons.edit,size: 30,color: Colors.white70,),
                                )
